---NCLua HTTP v0.9.9: Módulo para envio e recebimento de requisições HTTP em aplicações NCLua para TV Digital,
...
--@return Retorna o header e o body da resposta da requisição HTTP
